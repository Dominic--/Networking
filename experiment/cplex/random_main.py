...
final_topology_template = "../topology/final/%s-final-0-topology"
remove_links_template = "../topology/remove/%s-remove-0-links"
demand_file_template = "../demand/%s-geant/%d.txt"
result_file_template = "result-%s-0"
files = 1000
...
for t in ['abilene', 'geant']:
    ...
    final_topology = final_topology_template % t
    remove_links = remove_links_template % t
