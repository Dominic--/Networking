...
Formally, the max link utilization of a routing $r$ on traffic matrix $D$ can be described as following:
\begin{equation}
U_r = \max_{(i,j)\in links_of(D)} 
\end{equation}
